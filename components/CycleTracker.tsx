...
const CycleTracker: React.FC<{ state: AppState }> = ({ state }) => {
	...
	const [nextMonth, setNextMonth] = React.useState<string>(getNextMonth());
					...
					<div className='flex items-center justify-between mb-8'>
						...
						<div className='flex items-center gap-4'>
							...
							<div className='flex gap-2'>
								<button className='p-2 hover:bg-gray-50 rounded-full border border-gray-100'>
									<ChevronLeft
										className='w-4 h-4'
								...
								<button className='p-2 hover:bg-gray-50 rounded-full border border-gray-100'>
									<ChevronRight className='w-4 h-4' onClick={handleNextMonth} />
								</button>
							</div>
						</div>
					</div>
									...
									<div
										className={`w-10 h-10 flex items-center justify-center rounded-2xl text-sm font-bold transition-all ${
											isPeriod
												...
												: isPredicted
													? 'border-2 border-dashed border-pink-200 text-pink-400'
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-xs text-orange-700 mt-1 leading-relaxed'>
									Your last cycle was 45 days, which is longer than your
									average. This is common during perimenopause.
								</p>
